...
const Hero = () => {
  return (
    <section className=" max-container padding-container flex flex-col gap-20 py-1 pb-32  lg:py-5 xl:flex-row">
      ...
      <div className="relative flex xl:flex-1 items-start ">
